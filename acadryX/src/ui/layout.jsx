...
// SIDEBAR
export function Sidebar({ open, school, user, nav, activeTab, onTabChange, onLogout }) {
  return (
    <>
      {open && (
        ...
        <div style={{ padding: "20px 16px 16px", borderBottom: "1px solid var(--border)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "var(--text-muted)" }}>{school?.shortName}</div>
            </div>
          </div>
        </div>
...
export function AppShell({ school, user, nav, activeTab, onTabChange, onLogout, sidebarOpen, onMenuToggle, children }) {
  return (
