...
function TeacherScores({ user }) {
  ...
  return (
    <div style={{ padding: 16 }} className="fade-up">
      <Btn onClick={() => TeacherHome()}>Home</Btn>
...
export function TeacherPortal({ user, school, onLogout }) {
...
export function ParentPortal({ user, school, onLogout }) {
...
export function AlumniPortal({ user, school, onLogout }) {
